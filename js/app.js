...
async function createBooking() {
  ...
  try {
    ...
    /*
      Controllo ulteriore prima dell'inserimento.
      Impedisce due clienti nello stesso orario.
    */
    ...
    if (error) {
      ...
      /*
        Se il database ha una protezione
        contro il doppio slot, mostriamo
        un messaggio chiaro.
      */
